...
- 前回の発表から職種別研修を挟みましたが、「技術の学びを発表する場ではなさそうだ」と判断しました。
  - 「Dev研修のここが難しかった！」は自分のためにもメンター陣営のためにも後日ドキュメントにまとめます。
- これは改めて1ヶ月間の研修を、大局的にふりかえった内容です。
- 結論で結んだあと、「これから:社会人というジョブに必要なスキル」という項目で改めて「これが足りなかった！」という反省を記しています。
...
「チームとしての自分はどうあるべきか？」に一定の気付きを得るまでの詳細な経緯
...
「オープンにすること」と重複するように思えるが、コミュニケーションは必ずしも情報がオープンならとれるというわけではなく、相手(の心理状態とか)を知っているか、が前提になるのではないか、という点で「オープンにすること」とは別に大切にしたい行いだと思う。
